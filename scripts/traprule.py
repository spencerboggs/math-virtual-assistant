...
print("")
print("")
fast_print(" Trapezoidal Rule Calculator")
fast_print(" v1.0.0")
print("")
print("")
...
while True:
    ...
    h = (b - a) / n
    result = 0.5 * (eval(function, {'__builtins__': None}, {'x': a}) + 2 * sum(eval(function, {'__builtins__': None}, {'x': a + i * h}) for i in range(1, n)) + eval(function, {'__builtins__': None}, {'x': b})) * h
